...
function M.print_random_elements(opts)
    ...
    elseif #secondary_tbl == 3 then
        ...
        print(get_random_element(tertiary_tbl1) .. '-' .. get_random_element(tertiary_tbl2) .. '-' .. get_random_element(tertiary_tbl3))
...
function M.dinamic_completer(arg_lead, cmd_line, cursor_pos)
